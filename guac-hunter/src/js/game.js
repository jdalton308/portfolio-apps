...
var $ = require('jquery'),
    ...
    resultLang = require('./utils/resultLang'),
...
$(function(){
  ...
  var GuacGame = {
    ...
    apiProxy: 'http://api.guachunter.com/guac-it-out',
    ...
    setAlternateLanguage: function() {
      ...
      Elem.introCopy.addClass('repeat').text('We know you know that guac is extra. But do you know what makes it so special?');
      Elem.howToListItem.text('Get your guac hunt on.');
      Elem.shareView.addClass('repeat');

      // For no-availability sign-up
      Elem.signUpSubhead.text("Holy guacamole! That free guac went fast. Sign up for mobile alerts below to stay ahead of the pack next time around.");
      ...
      function gameEvents() {
        ...
        Elem.resultBtn.click(function(){
          ...
          if (GuacGame.photosPlayed == GuacGame.totalPhotos) {
            ...
            if (GuacGame.playedBefore) {
              window.open("https://www.chipotle.com/guac-recipe");
              GuacGame.share();
    ...
    signup: function() {
      ...
      //    - form validation checks text input for class 'valid', then checkbox
      ...
      function getFormData() {
        ...
        var consent = (Elem.consent.val()) ? 'true' : 'false';
      ...
      Elem.inputs.keyup(function(){
        ...
        if (!$this.hasClass('touched') || !($this.hasClass('zip') && validateZip($this)) )
          return
              ...
              function(data, status, XHR){
                ...
                if (!GuacGame.offersAvailable) {
                  ...
                  if (isRepeat) {
                    ...
                    Elem.youGuacCopyCont.html("<p>Sorry, you've already claimed your free chips and gauc. Limit one per mobile number.</p>");
                  }
